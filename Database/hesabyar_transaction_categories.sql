...
CREATE TABLE `transaction_categories` (
  ...
  KEY `transaction_categories_parent_id_foreign_idx` (`parent_category_id`),
  CONSTRAINT `transaction_categories_parent_id_foreign` FOREIGN KEY (`parent_category_id`) REFERENCES `transaction_categories` (`id`)
