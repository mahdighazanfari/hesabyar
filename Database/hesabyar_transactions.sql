...
CREATE TABLE `transactions` (
  ...
  `financial_group_id` int(10) unsigned NOT NULL,
  ...
  KEY `transactions_financial_group_id_foreign_idx` (`financial_group_id`),
  KEY `transactions_account_id_foreign_idx` (`account_id`),
  KEY `trasnactions_trasnaction_category_id_idx` (`transaction_category_id`),
  CONSTRAINT `transactions_account_id` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`account_type_id`),
  CONSTRAINT `transactions_group_id_foreign` FOREIGN KEY (`financial_group_id`) REFERENCES `financial_groups` (`id`),
