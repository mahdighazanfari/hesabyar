...
CREATE TABLE `accounts` (
  ...
  KEY `accounts_account_category_id_foreign_idx` (`account_category_id`),
  CONSTRAINT `accounts_account_category_id_foreign` FOREIGN KEY (`account_category_id`) REFERENCES `account_categories` (`id`),
...
-- Dump completed on 2019-12-24  9:03:00
